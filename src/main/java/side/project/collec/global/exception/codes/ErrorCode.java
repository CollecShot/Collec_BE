package side.project.collec.global.exception.codes;
...
public enum ErrorCode {
    ...
    NOT_SIGN_IN_KAKAO_ID(404, HttpStatus.NOT_FOUND, "회원가입되지 않은 카카오 계정입니다. 회원가입을 진행해 주세요."),
     ...
     * 409 Conflict
     */
    DUPLICATE_USER_NAME(409, HttpStatus.CONFLICT, "이미 존재하는 유저 이름입니다."),
    DUPLICATE_KAKAO_ID(409, HttpStatus.CONFLICT, "이미 회원가입 된 카카오 계정입니다."),

    /**
     *  500 INTERNAL SERVER ERROR
     */
    INTERNAL_SERVER_ERROR(500, HttpStatus.INTERNAL_SERVER_ERROR, "서버 내부 오류입니다. 잠시 후 다시 시도해주세요."),
    FILE_UPLOAD_FAILED(500, HttpStatus.INTERNAL_SERVER_ERROR, "스크린샷 업로드에 실패했습니다. 파일을 확인해주세요."),
    AI_MODEL_ERROR(500, HttpStatus.INTERNAL_SERVER_ERROR, "인공지능 모델에서 오류가 발생했습니다. 스크린샷 분류를 시도할 수 없습니다."),
     ...
     *  200 OK (알림 및 상태 관련)
     */
    SCREENSHOT_PROCESSED(200, HttpStatus.OK, "스크린샷이 성공적으로 처리되었습니다."),
